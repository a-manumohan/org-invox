...
[[https://melpa.org/#/org-invox][https://melpa.org/packages/org-invox-badge.svg]]
...
- *Configurable tax* — HST, GST, VAT, or any tax label/rate per contract; optional tax registration number shown on the tax line
...
(setq org-invox-from-name "Jane Smith"
      ...
      org-invox-from-tax-number "123456789RT0001"   ; optional — leave "" to omit
...
|-------------------------------------+--------------------------------+------------------------------------------|
| =org-invox-from-name=            | =""=                           | Your name (shown below company name)     |
| =org-invox-from-company=         | =""=                           | Your company/business name               |
| =org-invox-from-address=         | =""=                           | Your address                             |
| =org-invox-from-email=           | =""=                           | Your email                               |
| =org-invox-from-phone=           | =""=                           | Your phone                               |
| =org-invox-from-tax-number=      | =""=                           | Tax registration number (optional); shown on the tax line as =HST #<number> (13%)= |
...
| =<<TAX_LABEL>>=      | Tax label, including registration number if set (e.g., =HST #123456789RT0001=) |
...
3. *Immediately after:* =M-x org-invox-export-pdf= — generate PDF in =exports/= to send
4. *When paid:* =M-x org-invox-mark-paid= — update status (summary auto-updates)
5. *Periodically:* =M-x org-invox-list-unpaid= — check outstanding invoices
6. *On demand:* =M-x org-invox-update-summary= — refresh financial totals in the contract index
